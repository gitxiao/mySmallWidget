...
window.onresize = function () {
 	watermark({ watermark_txt: mark,watermark_width:50 }) 
};

var oTemp = null;
function watermark(settings) {
	//myUtils.printObject(settings,'settings',2);
	//myUtils.printObject(arguments,'arguments',2);
    ...
    mark = defaultSettings.watermark_txt;
    ...
    //console.log('page_width,page_height = ' + page_width + ',' + page_height);
